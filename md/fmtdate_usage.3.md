...
<div id="Content">
<CENTER>
<H1><HR><I>Manual Reference Pages &nbsp;-&nbsp;</I><NOBR>fmtdate_usage (3)</NOBR><HR></H1>
</CENTER>
<A name=0>
...
<BLOCKQUOTE>
<B>fmtdate_usage(3f) </B>- [M_time] display macros recognized by <B>fmtdate</B>(3f) and <B>now</B>(3f)
<B>(LICENSE:PD)
</B><B>
</B></BLOCKQUOTE>
...
<BLOCKQUOTE>
<P>
The <B>fmtdate_usage</B>(3f) subroutine displays the formatting options
available for use in procedures such as <B>fmtdate</B>(3f) and <B>now</B>(3f).
It is typically used to produce up-to-date help text in commands
that use the <B>M_time</B>(3fm) module, so that the formatting information
...
<B></B><I>indent</I> </TD><TD valign=bottom>
how many spaces to prefix the output with, so that
...
<P><HR>
<TABLE width=100%><TR> <TD width=33%><I></I></TD> <TD width=33% align=center>fmtdate_usage (3)</TD> <TD align=right width=33%><I>December 13, 2019</I></TD> </TR></TABLE><FONT SIZE=-1>Generated by <A HREF="http://www.squarebox.co.uk/download/manServer.shtml">manServer 1.08</A> from ce6828ec-cc59-423a-ad08-e82b50cc100d using man macros.</FONT>
</div>
</div>
</body>
</HTML>
