...
<div id="Content">
<CENTER>
<H1><HR><I>Manual Reference Pages &nbsp;-&nbsp;</I><NOBR>date_to_julian (3)</NOBR><HR></H1>
</CENTER>
<A name=0>
...
<BLOCKQUOTE>
<B>date_to_julian(3f) </B>- [M_time] converts DAT date-time array to Julian Date
<B>(LICENSE:PD)
</B><B>
</B></BLOCKQUOTE>
...
to the array returned by the intrinsic <B>DATE_AND_TIME</B>(3f).
</TD></TR>
<TR></TR></TABLE><!-- .nf -->
<PRE>
...
<B>juliandate</B> </TD></TR><TR valign=top><TD width=6%>&nbsp;</TD><TD>
A Julian Ephemeris Date (JED) is the number of days since
...
<P><HR>
<TABLE width=100%><TR> <TD width=33%><I></I></TD> <TD width=33% align=center>date_to_julian (3)</TD> <TD align=right width=33%><I>December 13, 2019</I></TD> </TR></TABLE><FONT SIZE=-1>Generated by <A HREF="http://www.squarebox.co.uk/download/manServer.shtml">manServer 1.08</A> from c60c7ff3-8cfb-438c-ad6d-0fb3b5dc6603 using man macros.</FONT>
</div>
</div>
</body>
</HTML>
