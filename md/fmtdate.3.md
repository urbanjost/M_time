...
<div id="Content">
<CENTER>
<H1><HR><I>Manual Reference Pages &nbsp;-&nbsp;</I><NOBR>fmtdate (3)</NOBR><HR></H1>
</CENTER>
<A name=0>
...
<BLOCKQUOTE>
<B>fmtdate(3f) </B>- [M_time] given DAT date-time array return date as string using specified format
<B>(LICENSE:PD)
</B><B>
</B></BLOCKQUOTE>
...
<BLOCKQUOTE>
The <B>fmtdate</B>(3f) procedure lets you reformat a DAT array in
...
the values returned by the intrinsic <B>DATE_AND_TIME</B>(3f).
<P>
...
supported see <B>fmtdate_usage</B>(3f).
</TD></TR>
...
<B></B><I>timestr</I> </TD></TR><TR valign=top><TD width=6%>&nbsp;</TD><TD>
...
<P><HR>
<TABLE width=100%><TR> <TD width=33%><I></I></TD> <TD width=33% align=center>fmtdate (3)</TD> <TD align=right width=33%><I>December 13, 2019</I></TD> </TR></TABLE><FONT SIZE=-1>Generated by <A HREF="http://www.squarebox.co.uk/download/manServer.shtml">manServer 1.08</A> from 453d2a52-24fa-4d5a-839c-37c4c9cc9190 using man macros.</FONT>
</div>
</div>
</body>
</HTML>
