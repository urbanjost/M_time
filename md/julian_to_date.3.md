...
<div id="Content">
<CENTER>
<H1><HR><I>Manual Reference Pages &nbsp;-&nbsp;</I><NOBR>julian_to_date (3)</NOBR><HR></H1>
</CENTER>
<A name=0>
...
<BLOCKQUOTE>
<B>julian_to_date(3f) </B>- [M_time] converts a <B>JED</B>(Julian Ephemeris Date) to a DAT date-time array.
<B>(LICENSE:PD)
</B><B>
</B></BLOCKQUOTE>
...
<B>julian</B> </TD><TD valign=bottom>
Julian Date (days)
</TD></TR>
<TR valign=top><TD width=6% nowrap>
...
<P><HR>
<TABLE width=100%><TR> <TD width=33%><I></I></TD> <TD width=33% align=center>julian_to_date (3)</TD> <TD align=right width=33%><I>December 13, 2019</I></TD> </TR></TABLE><FONT SIZE=-1>Generated by <A HREF="http://www.squarebox.co.uk/download/manServer.shtml">manServer 1.08</A> from 03a8cd49-85d8-4c0d-97a2-3a06d83a3294 using man macros.</FONT>
</div>
</div>
</body>
</HTML>
