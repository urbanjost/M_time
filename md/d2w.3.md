...
<BLOCKQUOTE>
<B>d2w(3f) </B>- [M_time] calculate iso-8601 Week-numbering year date yyyy-Www-d given DAT date-time array
<B>(LICENSE:PD)
</B><B>
</B></BLOCKQUOTE>
...
<P><HR>
<TABLE width=100%><TR> <TD width=33%><I></I></TD> <TD width=33% align=center>d2w (3)</TD> <TD align=right width=33%><I>December 13, 2019</I></TD> </TR></TABLE><FONT SIZE=-1>Generated by <A HREF="http://www.squarebox.co.uk/download/manServer.shtml">manServer 1.08</A> from fa9872a1-787c-4f9c-83fa-ec4f964aa54f using man macros.</FONT>
</div>
</div>
</body>
</HTML>
