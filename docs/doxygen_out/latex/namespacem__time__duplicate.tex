...
\hypertarget{namespacem__time__duplicate_autotoc_md103}{}\doxysubsubsection{N\+A\+ME}\label{namespacem__time__duplicate_autotoc_md103}
string\+\_\+to\+\_\+value(3f) -\/ \mbox{[}M\+\_\+strings\+:N\+U\+M\+E\+R\+IC\mbox{]} subroutine returns numeric value from string (L\+I\+C\+E\+N\+SE\+:PD)\hypertarget{namespacem__time__duplicate_autotoc_md104}{}\doxysubsubsection{S\+Y\+N\+O\+P\+S\+IS}\label{namespacem__time__duplicate_autotoc_md104}
...
\end{DoxyVerb}
 \hypertarget{namespacem__time__duplicate_autotoc_md105}{}\doxysubsubsection{D\+E\+S\+C\+R\+I\+P\+T\+I\+ON}\label{namespacem__time__duplicate_autotoc_md105}
...
if an error occurs in the R\+E\+AD, I\+O\+S\+T\+AT is returned in I\+E\+RR and value is set to zero. if no error occurs, I\+E\+RR=0. \hypertarget{namespacem__time__duplicate_autotoc_md106}{}\doxysubsubsection{O\+P\+T\+I\+O\+NS}\label{namespacem__time__duplicate_autotoc_md106}
C\+H\+A\+RS input string to read numeric value from \hypertarget{namespacem__time__duplicate_autotoc_md107}{}\doxysubsubsection{R\+E\+T\+U\+R\+NS}\label{namespacem__time__duplicate_autotoc_md107}
V\+A\+LU numeric value returned. May be I\+N\+T\+E\+G\+ER, R\+E\+AL, or D\+O\+U\+B\+L\+E\+P\+R\+E\+C\+I\+S\+I\+ON. I\+E\+RR error flag (0 == no error) \hypertarget{namespacem__time__duplicate_autotoc_md108}{}\doxysubsubsection{E\+X\+A\+M\+P\+LE}\label{namespacem__time__duplicate_autotoc_md108}
...
\end{DoxyVerb}
 \hypertarget{namespacem__time__duplicate_autotoc_md109}{}\doxysubsubsection{A\+U\+T\+H\+OR}\label{namespacem__time__duplicate_autotoc_md109}
John S. Urban \hypertarget{namespacem__time__duplicate_autotoc_md110}{}\doxysubsubsection{L\+I\+C\+E\+N\+SE}\label{namespacem__time__duplicate_autotoc_md110}
Public Domain
\begin{DoxyParams}[1]{Parameters}
...
\hypertarget{namespacem__time__duplicate_autotoc_md29}{}\doxysubsubsection{N\+A\+ME}\label{namespacem__time__duplicate_autotoc_md29}
adjustc(3f) -\/ \mbox{[}M\+\_\+strings\+:W\+H\+I\+T\+E\+S\+P\+A\+CE\mbox{]} center text (L\+I\+C\+E\+N\+SE\+:PD)\hypertarget{namespacem__time__duplicate_autotoc_md30}{}\doxysubsubsection{S\+Y\+N\+O\+P\+S\+IS}\label{namespacem__time__duplicate_autotoc_md30}
pure function adjustc(string\mbox{[},length\mbox{]})

character(len=$\ast$),intent(in) \+:: string integer,intent(in),optional \+:: length character(len=\+:),allocatable \+:: adjustc \hypertarget{namespacem__time__duplicate_autotoc_md31}{}\doxysubsubsection{D\+E\+S\+C\+R\+I\+P\+T\+I\+ON}\label{namespacem__time__duplicate_autotoc_md31}
Centers input text in a string of the length specified. Returns a string of length L\+E\+N\+G\+TH if L\+E\+N\+G\+TH is present. Otherwise returns a string of the length of the input string. \hypertarget{namespacem__time__duplicate_autotoc_md32}{}\doxysubsubsection{O\+P\+T\+I\+O\+NS}\label{namespacem__time__duplicate_autotoc_md32}
string input string to trim and center length line length to center text in, optional. \hypertarget{namespacem__time__duplicate_autotoc_md33}{}\doxysubsubsection{R\+E\+T\+U\+R\+NS}\label{namespacem__time__duplicate_autotoc_md33}
adjustc centered output string\hypertarget{namespacem__time__duplicate_autotoc_md34}{}\doxysubsubsection{E\+X\+A\+M\+P\+L\+ES}\label{namespacem__time__duplicate_autotoc_md34}
\begin{DoxyVerb}Sample Program:
...
Expected output:
 ...
 \==================================================
\end{DoxyVerb}
 \hypertarget{namespacem__time__duplicate_autotoc_md35}{}\doxysubsubsection{A\+U\+T\+H\+OR}\label{namespacem__time__duplicate_autotoc_md35}
John S. Urban \hypertarget{namespacem__time__duplicate_autotoc_md36}{}\doxysubsubsection{L\+I\+C\+E\+N\+SE}\label{namespacem__time__duplicate_autotoc_md36}
Public Domain
\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{ in}}  & {\em string} & P\+R\+O\+C\+E\+D\+U\+RE adjustc(3f) D\+E\+S\+C\+R\+I\+P\+T\+I\+ON center text using implicit or explicit length \\
\hline
\end{DoxyParams}
\hypertarget{namespacem__time__duplicate_autotoc_md38}{}\doxysubsubsection{V\+E\+R\+S\+I\+O\+N     2.\+0, 20160711}\label{namespacem__time__duplicate_autotoc_md38}
...
\hypertarget{namespacem__time__duplicate_autotoc_md39}{}\doxysubsubsection{N\+A\+ME}\label{namespacem__time__duplicate_autotoc_md39}
compact(3f) -\/ \mbox{[}M\+\_\+strings\+:W\+H\+I\+T\+E\+S\+P\+A\+CE\mbox{]} converts contiguous whitespace to a single character (or nothing) (L\+I\+C\+E\+N\+SE\+:PD)\hypertarget{namespacem__time__duplicate_autotoc_md40}{}\doxysubsubsection{S\+Y\+N\+O\+P\+S\+IS}\label{namespacem__time__duplicate_autotoc_md40}
...
\end{DoxyVerb}
 \hypertarget{namespacem__time__duplicate_autotoc_md41}{}\doxysubsubsection{D\+E\+S\+C\+R\+I\+P\+T\+I\+ON}\label{namespacem__time__duplicate_autotoc_md41}
C\+O\+M\+P\+A\+C\+T(3f) converts multiple spaces, tabs and control characters (called \char`\"{}whitespace\char`\"{}) to a single character or nothing. Leading whitespace is removed.\hypertarget{namespacem__time__duplicate_autotoc_md42}{}\doxysubsubsection{O\+P\+T\+I\+O\+NS}\label{namespacem__time__duplicate_autotoc_md42}
S\+TR input string to reduce or remove whitespace from C\+H\+AR By default the character that replaces adjacent whitespace is a space. If the optional C\+H\+AR parameter is supplied it will be used to replace the whitespace. If a null character is supplied for C\+H\+AR whitespace is removed. \hypertarget{namespacem__time__duplicate_autotoc_md43}{}\doxysubsubsection{R\+E\+T\+U\+R\+NS}\label{namespacem__time__duplicate_autotoc_md43}
O\+U\+T\+S\+TR string of same length as input string but with all contiguous whitespace reduced to a single space and leading whitespace removed\hypertarget{namespacem__time__duplicate_autotoc_md44}{}\doxysubsubsection{E\+X\+A\+M\+P\+L\+ES}\label{namespacem__time__duplicate_autotoc_md44}
\begin{DoxyVerb}Sample Program:
...
Expected output
 ...
 >AAAAAAAAAAAA
\end{DoxyVerb}
 \hypertarget{namespacem__time__duplicate_autotoc_md45}{}\doxysubsubsection{A\+U\+T\+H\+OR}\label{namespacem__time__duplicate_autotoc_md45}
John S. Urban \hypertarget{namespacem__time__duplicate_autotoc_md46}{}\doxysubsubsection{L\+I\+C\+E\+N\+SE}\label{namespacem__time__duplicate_autotoc_md46}
...
\hypertarget{namespacem__time__duplicate_autotoc_md80}{}\doxysubsubsection{N\+A\+ME}\label{namespacem__time__duplicate_autotoc_md80}
v2s(3f) -\/ \mbox{[}M\+\_\+strings\+:N\+U\+M\+E\+R\+IC\mbox{]} return numeric string from a numeric value (L\+I\+C\+E\+N\+SE\+:PD)\hypertarget{namespacem__time__duplicate_autotoc_md81}{}\doxysubsubsection{S\+Y\+N\+O\+P\+S\+IS}\label{namespacem__time__duplicate_autotoc_md81}
...
\end{DoxyVerb}
\hypertarget{namespacem__time__duplicate_autotoc_md82}{}\doxysubsubsection{D\+E\+S\+C\+R\+I\+P\+T\+I\+ON}\label{namespacem__time__duplicate_autotoc_md82}
v2s(3f) returns a representation of a numeric value as a string when given a numeric value of type R\+E\+AL, D\+O\+U\+B\+L\+E\+P\+R\+E\+C\+I\+S\+I\+ON, I\+N\+T\+E\+G\+ER or L\+O\+G\+I\+C\+AL. It creates the strings using internal W\+R\+I\+T\+E() statements. Trailing zeros are removed from non-\/zero values, and the string is left-\/justified.\hypertarget{namespacem__time__duplicate_autotoc_md83}{}\doxysubsubsection{O\+P\+T\+I\+O\+NS}\label{namespacem__time__duplicate_autotoc_md83}
V\+A\+L\+UE input value to be converted to a string F\+MT format can be explicitly given, but is limited to generating a string of eighty or less characters.\hypertarget{namespacem__time__duplicate_autotoc_md84}{}\doxysubsubsection{R\+E\+T\+U\+R\+NS}\label{namespacem__time__duplicate_autotoc_md84}
O\+U\+T\+S\+TR returned string representing input value,\hypertarget{namespacem__time__duplicate_autotoc_md85}{}\doxysubsubsection{E\+X\+A\+M\+P\+LE}\label{namespacem__time__duplicate_autotoc_md85}
\begin{DoxyVerb}Sample Program:
...
\end{DoxyVerb}
\hypertarget{namespacem__time__duplicate_autotoc_md86}{}\doxysubsubsection{A\+U\+T\+H\+OR}\label{namespacem__time__duplicate_autotoc_md86}
John S. Urban \hypertarget{namespacem__time__duplicate_autotoc_md87}{}\doxysubsubsection{L\+I\+C\+E\+N\+SE}\label{namespacem__time__duplicate_autotoc_md87}
Public Domain 
...
\hypertarget{namespacem__time__duplicate_autotoc_md111}{}\doxysubsubsection{N\+A\+ME}\label{namespacem__time__duplicate_autotoc_md111}
decodebase(3f) -\/ \mbox{[}M\+\_\+strings\+:B\+A\+SE\mbox{]} convert whole number string in base \mbox{[}2-\/36\mbox{]} to base 10 number (L\+I\+C\+E\+N\+SE\+:PD)\hypertarget{namespacem__time__duplicate_autotoc_md112}{}\doxysubsubsection{S\+Y\+N\+O\+P\+S\+IS}\label{namespacem__time__duplicate_autotoc_md112}
...
\end{DoxyVerb}
 \hypertarget{namespacem__time__duplicate_autotoc_md113}{}\doxysubsubsection{D\+E\+S\+C\+R\+I\+P\+T\+I\+ON}\label{namespacem__time__duplicate_autotoc_md113}
...
The letters A,B,...,Z represent 10,11,...,36 in the base $>$ 10.\hypertarget{namespacem__time__duplicate_autotoc_md114}{}\doxysubsubsection{O\+P\+T\+I\+O\+NS}\label{namespacem__time__duplicate_autotoc_md114}
string input string. It represents a whole number in the base specified by B\+A\+S\+E\+IN unless B\+A\+S\+E\+IN is set to zero. When B\+A\+S\+E\+IN is zero S\+T\+R\+I\+NG is assumed to be of the form B\+A\+S\+E\+::\+V\+A\+L\+UE where B\+A\+SE represents the function normally provided by B\+A\+S\+E\+IN. basein base of input string; either 0 or from 2 to 36. out10 output value in base 10\hypertarget{namespacem__time__duplicate_autotoc_md115}{}\doxysubsubsection{E\+X\+A\+M\+P\+LE}\label{namespacem__time__duplicate_autotoc_md115}
\begin{DoxyVerb}Sample program:
...
\end{DoxyVerb}
\hypertarget{namespacem__time__duplicate_autotoc_md116}{}\doxysubsubsection{A\+U\+T\+H\+OR}\label{namespacem__time__duplicate_autotoc_md116}
John S. Urban

Ref.\+: "Math matiques en Turbo-\/\+Pascal by M. Ducamp and A. Reverchon (2), Eyrolles, Paris, 1988".

based on a F90 Version By J-\/P Moreau (www.\+jpmoreau.\+fr)\hypertarget{namespacem__time__duplicate_autotoc_md117}{}\doxysubsubsection{L\+I\+C\+E\+N\+SE}\label{namespacem__time__duplicate_autotoc_md117}
Public Domain 
...
\hypertarget{namespacem__time__duplicate_autotoc_md20}{}\doxysubsubsection{N\+A\+ME}\label{namespacem__time__duplicate_autotoc_md20}
lower(3f) -\/ \mbox{[}M\+\_\+strings\+:C\+A\+SE\mbox{]} changes a string to lowercase over specified range (L\+I\+C\+E\+N\+SE\+:PD)\hypertarget{namespacem__time__duplicate_autotoc_md21}{}\doxysubsubsection{S\+Y\+N\+O\+P\+S\+IS}\label{namespacem__time__duplicate_autotoc_md21}
...
\end{DoxyVerb}
 \hypertarget{namespacem__time__duplicate_autotoc_md22}{}\doxysubsubsection{D\+E\+S\+C\+R\+I\+P\+T\+I\+ON}\label{namespacem__time__duplicate_autotoc_md22}
lower(string) returns a copy of the input string with all characters converted to miniscule over the specified range, assuming A\+S\+C\+II character sets are being used. If no range is specified the entire string is converted to miniscule.\hypertarget{namespacem__time__duplicate_autotoc_md23}{}\doxysubsubsection{O\+P\+T\+I\+O\+NS}\label{namespacem__time__duplicate_autotoc_md23}
str string to convert to miniscule begin optional starting position in \char`\"{}str\char`\"{} to begin converting to miniscule end optional ending position in \char`\"{}str\char`\"{} to stop converting to miniscule\hypertarget{namespacem__time__duplicate_autotoc_md24}{}\doxysubsubsection{R\+E\+S\+U\+L\+TS}\label{namespacem__time__duplicate_autotoc_md24}
lower copy of the input string with all characters converted to miniscule over optionally specified range.\hypertarget{namespacem__time__duplicate_autotoc_md25}{}\doxysubsubsection{T\+R\+I\+V\+IA}\label{namespacem__time__duplicate_autotoc_md25}
The terms \char`\"{}uppercase\char`\"{} and \char`\"{}lowercase\char`\"{} date back to the early days of the mechanical printing press. Individual metal alloy casts of each needed letter, or punctuation symbol, were meticulously added to a press block, by hand, before rolling out copies of a page. These metal casts were stored and organized in wooden cases. The more often needed miniscule letters were placed closer to hand, in the lower cases of the work bench. The less often needed, capitalized, majuscule letters, ended up in the harder to reach upper cases.\hypertarget{namespacem__time__duplicate_autotoc_md26}{}\doxysubsubsection{E\+X\+A\+M\+P\+LE}\label{namespacem__time__duplicate_autotoc_md26}
\begin{DoxyVerb}Sample program:
...
\end{DoxyVerb}
 \hypertarget{namespacem__time__duplicate_autotoc_md27}{}\doxysubsubsection{A\+U\+T\+H\+OR}\label{namespacem__time__duplicate_autotoc_md27}
John S. Urban \hypertarget{namespacem__time__duplicate_autotoc_md28}{}\doxysubsubsection{L\+I\+C\+E\+N\+SE}\label{namespacem__time__duplicate_autotoc_md28}
...
\hypertarget{namespacem__time__duplicate_autotoc_md47}{}\doxysubsubsection{N\+A\+ME}\label{namespacem__time__duplicate_autotoc_md47}
s2v(3f) -\/ \mbox{[}M\+\_\+strings\+:N\+U\+M\+E\+R\+IC\mbox{]} function returns doubleprecision numeric value from a string (L\+I\+C\+E\+N\+SE\+:PD)\hypertarget{namespacem__time__duplicate_autotoc_md48}{}\doxysubsubsection{S\+Y\+N\+O\+P\+S\+IS}\label{namespacem__time__duplicate_autotoc_md48}
...
\end{DoxyVerb}
 \hypertarget{namespacem__time__duplicate_autotoc_md49}{}\doxysubsubsection{D\+E\+S\+C\+R\+I\+P\+T\+I\+ON}\label{namespacem__time__duplicate_autotoc_md49}
This function converts a string to a D\+O\+U\+B\+L\+E\+P\+R\+E\+C\+I\+S\+I\+ON numeric value.

The intrinsics I\+N\+T(3f), R\+E\+A\+L(3f), and D\+B\+L\+E(3f) are also extended to take C\+H\+A\+R\+A\+C\+T\+ER variables. The K\+I\+ND= keyword is not supported on the extensions. \hypertarget{namespacem__time__duplicate_autotoc_md50}{}\doxysubsubsection{O\+P\+T\+I\+O\+NS}\label{namespacem__time__duplicate_autotoc_md50}
...
\end{DoxyVerb}
 \hypertarget{namespacem__time__duplicate_autotoc_md51}{}\doxysubsubsection{R\+E\+T\+U\+R\+NS}\label{namespacem__time__duplicate_autotoc_md51}
s2v\hypertarget{namespacem__time__duplicate_autotoc_md52}{}\doxysubsubsection{E\+X\+A\+M\+P\+LE}\label{namespacem__time__duplicate_autotoc_md52}
\begin{DoxyVerb}Sample Program:
...
Expected output
 ...
 >That's all folks!
\end{DoxyVerb}
 \hypertarget{namespacem__time__duplicate_autotoc_md53}{}\doxysubsubsection{A\+U\+T\+H\+OR}\label{namespacem__time__duplicate_autotoc_md53}
John S. Urban \hypertarget{namespacem__time__duplicate_autotoc_md54}{}\doxysubsubsection{L\+I\+C\+E\+N\+SE}\label{namespacem__time__duplicate_autotoc_md54}
Public Domain\hypertarget{namespacem__time__duplicate_autotoc_md55}{}\doxysubsubsection{P\+R\+O\+C\+E\+D\+U\+R\+E\+:}\label{namespacem__time__duplicate_autotoc_md55}
D\+E\+S\+C\+R\+I\+P\+T\+I\+ON\+: s2v(3f)\+: function returns doubleprecision number from string;zero if error occurs \hypertarget{namespacem__time__duplicate_autotoc_md56}{}\doxysubsubsection{V\+E\+R\+S\+I\+O\+N\+:     2.\+0, 20160704}\label{namespacem__time__duplicate_autotoc_md56}
...
\hypertarget{namespacem__time__duplicate_autotoc_md57}{}\doxysubsubsection{N\+A\+ME}\label{namespacem__time__duplicate_autotoc_md57}
split(3f) -\/ \mbox{[}M\+\_\+strings\+:T\+O\+K\+E\+NS\mbox{]} parse string into an array using specified delimiters (L\+I\+C\+E\+N\+SE\+:PD)\hypertarget{namespacem__time__duplicate_autotoc_md58}{}\doxysubsubsection{S\+Y\+N\+O\+P\+S\+IS}\label{namespacem__time__duplicate_autotoc_md58}
...
\end{DoxyVerb}
 \hypertarget{namespacem__time__duplicate_autotoc_md59}{}\doxysubsubsection{D\+E\+S\+C\+R\+I\+P\+T\+I\+ON}\label{namespacem__time__duplicate_autotoc_md59}
S\+P\+L\+I\+T(3f) parses a string using specified delimiter characters and store tokens into an allocatable array\hypertarget{namespacem__time__duplicate_autotoc_md60}{}\doxysubsubsection{O\+P\+T\+I\+O\+NS}\label{namespacem__time__duplicate_autotoc_md60}
...
\end{DoxyVerb}
\hypertarget{namespacem__time__duplicate_autotoc_md61}{}\doxysubsubsection{E\+X\+A\+M\+P\+L\+ES}\label{namespacem__time__duplicate_autotoc_md61}
...
Output \begin{DoxyVerb} > INPUT LINE:[  aBcdef   ghijklmnop qrstuvwxyz  1:|:2     333|333 a B cc    ]
 ...
 >  SIZE:          20
\end{DoxyVerb}
 \hypertarget{namespacem__time__duplicate_autotoc_md62}{}\doxysubsubsection{A\+U\+T\+H\+OR}\label{namespacem__time__duplicate_autotoc_md62}
John S. Urban \hypertarget{namespacem__time__duplicate_autotoc_md63}{}\doxysubsubsection{L\+I\+C\+E\+N\+SE}\label{namespacem__time__duplicate_autotoc_md63}
Public Domain 
...
\hypertarget{namespacem__time__duplicate_autotoc_md64}{}\doxysubsubsection{N\+A\+ME}\label{namespacem__time__duplicate_autotoc_md64}
string\+\_\+to\+\_\+values(3f) -\/ \mbox{[}M\+\_\+strings\+:N\+U\+M\+E\+R\+IC\mbox{]} read a string representing numbers into a numeric array (L\+I\+C\+E\+N\+SE\+:PD)\hypertarget{namespacem__time__duplicate_autotoc_md65}{}\doxysubsubsection{S\+Y\+N\+O\+P\+S\+IS}\label{namespacem__time__duplicate_autotoc_md65}
\begin{DoxyVerb}   subroutine string_to_values(line,iread,values,inums,delims,ierr)
    ...
    integer          :: ierr
\end{DoxyVerb}
 \hypertarget{namespacem__time__duplicate_autotoc_md66}{}\doxysubsubsection{D\+E\+S\+C\+R\+I\+P\+T\+I\+ON}\label{namespacem__time__duplicate_autotoc_md66}
This routine can take a string representing a series of numbers and convert it to a numeric array and return how many numbers were found.\hypertarget{namespacem__time__duplicate_autotoc_md67}{}\doxysubsubsection{O\+P\+T\+I\+O\+NS}\label{namespacem__time__duplicate_autotoc_md67}
\begin{DoxyVerb}   LINE     Input string containing numbers
   IREAD    maximum number of values to try to read from input string
\end{DoxyVerb}
\hypertarget{namespacem__time__duplicate_autotoc_md68}{}\doxysubsubsection{R\+E\+S\+U\+L\+TS}\label{namespacem__time__duplicate_autotoc_md68}
...
\end{DoxyVerb}
\hypertarget{namespacem__time__duplicate_autotoc_md69}{}\doxysubsubsection{E\+X\+A\+M\+P\+LE}\label{namespacem__time__duplicate_autotoc_md69}
...
\end{DoxyVerb}
 \hypertarget{namespacem__time__duplicate_autotoc_md70}{}\doxysubsubsection{A\+U\+T\+H\+OR}\label{namespacem__time__duplicate_autotoc_md70}
John S. Urban \hypertarget{namespacem__time__duplicate_autotoc_md71}{}\doxysubsubsection{L\+I\+C\+E\+N\+SE}\label{namespacem__time__duplicate_autotoc_md71}
Public Domain 
...
\hypertarget{namespacem__time__duplicate_autotoc_md4}{}\doxysubsubsection{N\+A\+ME}\label{namespacem__time__duplicate_autotoc_md4}
substitute(3f) -\/ \mbox{[}M\+\_\+strings\+:E\+D\+I\+T\+I\+NG\mbox{]} subroutine globally substitutes one substring for another in string (L\+I\+C\+E\+N\+SE\+:PD)\hypertarget{namespacem__time__duplicate_autotoc_md5}{}\doxysubsubsection{S\+Y\+N\+O\+P\+S\+IS}\label{namespacem__time__duplicate_autotoc_md5}
...
\end{DoxyVerb}
 \hypertarget{namespacem__time__duplicate_autotoc_md6}{}\doxysubsubsection{D\+E\+S\+C\+R\+I\+P\+T\+I\+ON}\label{namespacem__time__duplicate_autotoc_md6}
Globally substitute one substring for another in string.\hypertarget{namespacem__time__duplicate_autotoc_md7}{}\doxysubsubsection{O\+P\+T\+I\+O\+NS}\label{namespacem__time__duplicate_autotoc_md7}
T\+A\+R\+G\+E\+T\+L\+I\+NE input line to be changed. Must be long enough to hold altered output. O\+LD substring to find and replace N\+EW replacement for O\+LD substring I\+E\+RR error code. If I\+ER = -\/1 bad directive, $>$= 0 then count of changes made. S\+T\+A\+RT sets the left margin to be scanned for O\+LD in T\+A\+R\+G\+E\+T\+L\+I\+NE. E\+ND sets the right margin to be scanned for O\+LD in T\+A\+R\+G\+E\+T\+L\+I\+NE.\hypertarget{namespacem__time__duplicate_autotoc_md8}{}\doxysubsubsection{E\+X\+A\+M\+P\+L\+ES}\label{namespacem__time__duplicate_autotoc_md8}
\begin{DoxyVerb}Sample Program:
...
\end{DoxyVerb}
 \hypertarget{namespacem__time__duplicate_autotoc_md9}{}\doxysubsubsection{A\+U\+T\+H\+OR}\label{namespacem__time__duplicate_autotoc_md9}
John S. Urban \hypertarget{namespacem__time__duplicate_autotoc_md10}{}\doxysubsubsection{L\+I\+C\+E\+N\+SE}\label{namespacem__time__duplicate_autotoc_md10}
Public Domain 
...
\hypertarget{namespacem__time__duplicate_autotoc_md72}{}\doxysubsubsection{N\+A\+ME}\label{namespacem__time__duplicate_autotoc_md72}
transliterate(3f) -\/ \mbox{[}M\+\_\+strings\+:E\+D\+I\+T\+I\+NG\mbox{]} replace characters from old set with new set (L\+I\+C\+E\+N\+SE\+:PD)\hypertarget{namespacem__time__duplicate_autotoc_md73}{}\doxysubsubsection{S\+Y\+N\+O\+P\+S\+IS}\label{namespacem__time__duplicate_autotoc_md73}
...
\end{DoxyVerb}
 \hypertarget{namespacem__time__duplicate_autotoc_md74}{}\doxysubsubsection{D\+E\+S\+C\+R\+I\+P\+T\+I\+ON}\label{namespacem__time__duplicate_autotoc_md74}
Translate, squeeze, and/or delete characters from the input string.\hypertarget{namespacem__time__duplicate_autotoc_md75}{}\doxysubsubsection{O\+P\+T\+I\+O\+NS}\label{namespacem__time__duplicate_autotoc_md75}
...
\end{DoxyVerb}
 \hypertarget{namespacem__time__duplicate_autotoc_md76}{}\doxysubsubsection{R\+E\+T\+U\+R\+NS}\label{namespacem__time__duplicate_autotoc_md76}
outstr instr with substitutions applied\hypertarget{namespacem__time__duplicate_autotoc_md77}{}\doxysubsubsection{E\+X\+A\+M\+P\+L\+ES}\label{namespacem__time__duplicate_autotoc_md77}
\begin{DoxyVerb}Sample Program:
...
\end{DoxyVerb}
\hypertarget{namespacem__time__duplicate_autotoc_md78}{}\doxysubsubsection{A\+U\+T\+H\+OR}\label{namespacem__time__duplicate_autotoc_md78}
John S. Urban \hypertarget{namespacem__time__duplicate_autotoc_md79}{}\doxysubsubsection{L\+I\+C\+E\+N\+SE}\label{namespacem__time__duplicate_autotoc_md79}
...
\hypertarget{namespacem__time__duplicate_autotoc_md96}{}\doxysubsubsection{N\+A\+ME}\label{namespacem__time__duplicate_autotoc_md96}
trimzeros(3fp) -\/ \mbox{[}M\+\_\+strings\+:N\+U\+M\+E\+R\+IC\mbox{]} Delete trailing zeros from numeric decimal string (L\+I\+C\+E\+N\+SE\+:PD) \hypertarget{namespacem__time__duplicate_autotoc_md97}{}\doxysubsubsection{S\+Y\+N\+O\+P\+S\+IS}\label{namespacem__time__duplicate_autotoc_md97}
\begin{DoxyVerb}subroutine trimzeros(str)

 character(len=*)  :: str
\end{DoxyVerb}
 \hypertarget{namespacem__time__duplicate_autotoc_md98}{}\doxysubsubsection{D\+E\+S\+C\+R\+I\+P\+T\+I\+ON}\label{namespacem__time__duplicate_autotoc_md98}
T\+R\+I\+M\+Z\+E\+R\+O\+S(3f) deletes trailing zeros from a string representing a number. If the resulting string would end in a decimal point, one trailing zero is added. \hypertarget{namespacem__time__duplicate_autotoc_md99}{}\doxysubsubsection{O\+P\+T\+I\+O\+NS}\label{namespacem__time__duplicate_autotoc_md99}
str input string will be assumed to be a numeric value and have trailing zeros removed \hypertarget{namespacem__time__duplicate_autotoc_md100}{}\doxysubsubsection{E\+X\+A\+M\+P\+L\+ES}\label{namespacem__time__duplicate_autotoc_md100}
\begin{DoxyVerb}Sample program:
...
\end{DoxyVerb}
\hypertarget{namespacem__time__duplicate_autotoc_md101}{}\doxysubsubsection{A\+U\+T\+H\+OR}\label{namespacem__time__duplicate_autotoc_md101}
John S. Urban \hypertarget{namespacem__time__duplicate_autotoc_md102}{}\doxysubsubsection{L\+I\+C\+E\+N\+SE}\label{namespacem__time__duplicate_autotoc_md102}
Public Domain Here is the caller graph for this function\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
...
\hypertarget{namespacem__time__duplicate_autotoc_md11}{}\doxysubsubsection{N\+A\+ME}\label{namespacem__time__duplicate_autotoc_md11}
upper(3f) -\/ \mbox{[}M\+\_\+strings\+:C\+A\+SE\mbox{]} changes a string to uppercase (L\+I\+C\+E\+N\+SE\+:PD)\hypertarget{namespacem__time__duplicate_autotoc_md12}{}\doxysubsubsection{S\+Y\+N\+O\+P\+S\+IS}\label{namespacem__time__duplicate_autotoc_md12}
\begin{DoxyVerb}elemental pure function upper(str,begin,end) result (string)
 ...
 character(len(str))         :: string  ! output string
\end{DoxyVerb}
 \hypertarget{namespacem__time__duplicate_autotoc_md13}{}\doxysubsubsection{D\+E\+S\+C\+R\+I\+P\+T\+I\+ON}\label{namespacem__time__duplicate_autotoc_md13}
upper(string) returns a copy of the input string with all characters converted in the optionally specified range to uppercase, assuming A\+S\+C\+II character sets are being used. If no range is specified the entire string is converted to uppercase.\hypertarget{namespacem__time__duplicate_autotoc_md14}{}\doxysubsubsection{O\+P\+T\+I\+O\+NS}\label{namespacem__time__duplicate_autotoc_md14}
str string to convert to uppercase begin optional starting position in \char`\"{}str\char`\"{} to begin converting to uppercase end optional ending position in \char`\"{}str\char`\"{} to stop converting to uppercase\hypertarget{namespacem__time__duplicate_autotoc_md15}{}\doxysubsubsection{R\+E\+S\+U\+L\+TS}\label{namespacem__time__duplicate_autotoc_md15}
upper copy of the input string with all characters converted to uppercase over optionally specified range.\hypertarget{namespacem__time__duplicate_autotoc_md16}{}\doxysubsubsection{T\+R\+I\+V\+IA}\label{namespacem__time__duplicate_autotoc_md16}
The terms \char`\"{}uppercase\char`\"{} and \char`\"{}lowercase\char`\"{} date back to the early days of the mechanical printing press. Individual metal alloy casts of each needed letter, or punctuation symbol, were meticulously added to a press block, by hand, before rolling out copies of a page. These metal casts were stored and organized in wooden cases. The more often needed miniscule letters were placed closer to hand, in the lower cases of the work bench. The less often needed, capitalized, majuscule letters, ended up in the harder to reach upper cases.\hypertarget{namespacem__time__duplicate_autotoc_md17}{}\doxysubsubsection{E\+X\+A\+M\+P\+LE}\label{namespacem__time__duplicate_autotoc_md17}
\begin{DoxyVerb}Sample program:
...
\end{DoxyVerb}
 \hypertarget{namespacem__time__duplicate_autotoc_md18}{}\doxysubsubsection{A\+U\+T\+H\+OR}\label{namespacem__time__duplicate_autotoc_md18}
John S. Urban \hypertarget{namespacem__time__duplicate_autotoc_md19}{}\doxysubsubsection{L\+I\+C\+E\+N\+SE}\label{namespacem__time__duplicate_autotoc_md19}
Public Domain Here is the caller graph for this function\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
...
\hypertarget{namespacem__time__duplicate_autotoc_md88}{}\doxysubsubsection{N\+A\+ME}\label{namespacem__time__duplicate_autotoc_md88}
value\+\_\+to\+\_\+string(3f) -\/ \mbox{[}M\+\_\+strings\+:N\+U\+M\+E\+R\+IC\mbox{]} return numeric string from a numeric value (L\+I\+C\+E\+N\+SE\+:PD)\hypertarget{namespacem__time__duplicate_autotoc_md89}{}\doxysubsubsection{S\+Y\+N\+O\+P\+S\+IS}\label{namespacem__time__duplicate_autotoc_md89}
...
\end{DoxyVerb}
 \hypertarget{namespacem__time__duplicate_autotoc_md90}{}\doxysubsubsection{D\+E\+S\+C\+R\+I\+P\+T\+I\+ON}\label{namespacem__time__duplicate_autotoc_md90}
value\+\_\+to\+\_\+string(3f) returns a numeric representation of a numeric value in a string given a numeric value of type R\+E\+AL, D\+O\+U\+B\+L\+E\+P\+R\+E\+C\+I\+S\+I\+ON, I\+N\+T\+E\+G\+ER or L\+O\+G\+I\+C\+AL. It creates the string using internal writes. It then removes trailing zeros from non-\/zero values, and left-\/justifies the string.\hypertarget{namespacem__time__duplicate_autotoc_md91}{}\doxysubsubsection{O\+P\+T\+I\+O\+NS}\label{namespacem__time__duplicate_autotoc_md91}
V\+A\+L\+UE input value to be converted to a string F\+MT You may specify a specific format that produces a string up to the length of C\+H\+A\+RS; optional. T\+R\+I\+MZ If a format is supplied the default is not to try to trim trailing zeros. Set T\+R\+I\+MZ to .true. to trim zeros from a string assumed to represent a simple numeric value.\hypertarget{namespacem__time__duplicate_autotoc_md92}{}\doxysubsubsection{R\+E\+T\+U\+R\+NS}\label{namespacem__time__duplicate_autotoc_md92}
C\+H\+A\+RS returned string representing input value, must be at least 23 characters long; or what is required by optional F\+MT if longer. I\+L\+EN position of last non-\/blank character in returned string; optional. I\+E\+RR If not zero, error occurred; optional. \hypertarget{namespacem__time__duplicate_autotoc_md93}{}\doxysubsubsection{E\+X\+A\+M\+P\+LE}\label{namespacem__time__duplicate_autotoc_md93}
\begin{DoxyVerb}Sample program:
...
\end{DoxyVerb}
\hypertarget{namespacem__time__duplicate_autotoc_md94}{}\doxysubsubsection{A\+U\+T\+H\+OR}\label{namespacem__time__duplicate_autotoc_md94}
John S. Urban \hypertarget{namespacem__time__duplicate_autotoc_md95}{}\doxysubsubsection{L\+I\+C\+E\+N\+SE}\label{namespacem__time__duplicate_autotoc_md95}
Public Domain 
