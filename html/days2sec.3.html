...
<div id="Content">
<CENTER>
<H1><HR><I>Manual Reference Pages &nbsp;-&nbsp;</I><NOBR>days2sec (3)</NOBR><HR></H1>
</CENTER>
<A name=0>
...
<BLOCKQUOTE>
<B>days2sec(3f) </B>- [M_time] convert string of form [[-]dd-]hh:mm:ss.nn to seconds
<B>(LICENSE:PD)
</B><B>
</B></BLOCKQUOTE>
...
<TABLE cellpadding=3><!-- tsb: Given a string representing a duration of the form
 -->
<TR></TR><TR></TR>
<TR valign=top><TD colspan=2>
<B>[-][[[dd-]hh:]mm:]ss</B> </TD></TR><TR valign=top><TD width=6%>&nbsp;</TD><TD>
or NNdNNhNNmNNsNNw
...
<B></B><I>str</I> </TD><TD valign=bottom>
...
<TABLE cellpadding=3>
<TR valign=top><TD width=6% nowrap>
<B></B><I>time</I> </TD><TD valign=bottom>
...
<P><HR>
<TABLE width=100%><TR> <TD width=33%><I></I></TD> <TD width=33% align=center>days2sec (3)</TD> <TD align=right width=33%><I>December 13, 2019</I></TD> </TR></TABLE><FONT SIZE=-1>Generated by <A HREF="http://www.squarebox.co.uk/download/manServer.shtml">manServer 1.08</A> from 16e8c9f7-eafe-4fcc-8b44-ec6c121fa5d0 using man macros.</FONT>
</div>
</div>
</body>
</HTML>
