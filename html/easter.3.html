...
<div id="Content">
<CENTER>
<H1><HR><I>Manual Reference Pages &nbsp;-&nbsp;</I><NOBR>easter (3)</NOBR><HR></H1>
</CENTER>
<A name=0>
...
<BLOCKQUOTE>
<B>easter(3f) </B>- [M_time] calculate date for Easter given a year
<B>(LICENSE:PD)
</B><B>
</B></BLOCKQUOTE>
...
<P>
The algorithm is due to J.<B>-M</B>. Oudin (1940) and is reprinted in the Explanatory
...
<P><HR>
<TABLE width=100%><TR> <TD width=33%><I></I></TD> <TD width=33% align=center>easter (3)</TD> <TD align=right width=33%><I>December 13, 2019</I></TD> </TR></TABLE><FONT SIZE=-1>Generated by <A HREF="http://www.squarebox.co.uk/download/manServer.shtml">manServer 1.08</A> from 6d352188-a0d0-45f2-bfcf-b8e0865bef1e using man macros.</FONT>
</div>
</div>
</body>
</HTML>
