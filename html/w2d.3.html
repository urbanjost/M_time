...
<BLOCKQUOTE>
<B>w2d(3f) </B>- [M_time] calculate DAT date-time array from iso-8601 Week-numbering year date yyyy-Www-d
<B>(LICENSE:PD)
</B><B>
</B></BLOCKQUOTE>
...
<P><HR>
<TABLE width=100%><TR> <TD width=33%><I></I></TD> <TD width=33% align=center>w2d (3)</TD> <TD align=right width=33%><I>December 13, 2019</I></TD> </TR></TABLE><FONT SIZE=-1>Generated by <A HREF="http://www.squarebox.co.uk/download/manServer.shtml">manServer 1.08</A> from 3d61ce7c-dc58-4cfe-9466-341999f6afd4 using man macros.</FONT>
</div>
</div>
</body>
</HTML>
