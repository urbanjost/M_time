...
<div id="Content">
<CENTER>
<H1><HR><I>Manual Reference Pages &nbsp;-&nbsp;</I><NOBR>d2o (3)</NOBR><HR></H1>
</CENTER>
<A name=0>
...
<BLOCKQUOTE>
<B>d2o(3f) </B>- [M_time] converts DAT date-time array to Ordinal day
<B>(LICENSE:PD)
</B><B>
</B></BLOCKQUOTE>
...
<B></B><I>dat</I> </TD><TD valign=bottom>
...
<B></B><I>ordinal</I> </TD></TR><TR valign=top><TD width=6%>&nbsp;</TD><TD>
The day of the year calculated for the given input date,
where Jan 1st=1.
</TD></TR>
...
<P><HR>
<TABLE width=100%><TR> <TD width=33%><I></I></TD> <TD width=33% align=center>d2o (3)</TD> <TD align=right width=33%><I>December 13, 2019</I></TD> </TR></TABLE><FONT SIZE=-1>Generated by <A HREF="http://www.squarebox.co.uk/download/manServer.shtml">manServer 1.08</A> from 190ca75a-63da-4b8b-9b83-0b74551b0d0d using man macros.</FONT>
</div>
</div>
</body>
</HTML>
